...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'admin') {
    header("Location: http://localhost/php template/shop/public/index.php?controller=auth&action=login");
    exit;
}
?>
<!DOCTYPE html>
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <?php if ($_SESSION['role'] === 'admin'): ?>
                            <a href="http://localhost/php template/Module_main/public/index.php?controller=order&action=admin"><i class="fa fa-flash "></i>Quản lí sản đơn hàng </a>
                        <?php endif; ?>
                        <?php if ($_SESSION['role'] === 'admin'): ?>
                            <a href="http://localhost/php%20template/Module_main/public/index.php?controller=product&action=manage"><i class="fa fa-flash "></i>Quản lí sản sản phẩm </a>
                        <?php endif; ?>
                    ...
                    <li>
                        <a href="http://localhost/php template/shop/public/index.php?controller=auth&action=logout"><i class="fa fa-square-o "></i>Logout</a>
                    </li>
                </ul>
