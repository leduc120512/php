...
<body>
    <div id="wrapper">
        ...
        <div class="panel-body">
            <form method="GET" action="?controller=order&action=viewOrders" class="form-inline mb-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="product_name" id="product_name" class="form-control" value="<?php echo isset($_GET['product_name']) ? htmlspecialchars($_GET['product_name']) : ''; ?>">
                </div>
                <div class="form-group">
